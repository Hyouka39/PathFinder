...
export default function AdminLogin() {
  ...
  return (
    <div className="flex justify-center items-center absolute inset-0 -z-10 h-full w-full [background:radial-gradient(125%_125%_at_50%_30%,#fff_1%,#7d6655_100%)]">
      <div className="bg-white p-8 md:p-12 lg:p-16 rounded-lg shadow-lg w-full max-w-xs md:max-w-sm lg:max-w-md">
        <div className="flex justify-center mb-6">
          <Image src={Logo} alt="Company Logo" width={150} height={150} />
        </div>
        <h2 className="text-4xl lg:text-4xl font-semibold mb-6 text-center text-black">PathFinder</h2>
        <form onSubmit={handleLogin} autoComplete="off">
          <div className="mb-4 relative">
            <input
              type="text"
              placeholder="Enter your username"
              className="w-full p-4 pr-10 border rounded-lg focus:outline-none focus:ring-2 focus:ring-brown-6 bg-white text-black"
              value={username}
