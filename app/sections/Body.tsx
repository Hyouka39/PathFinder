      ...
      <div className='pt-28 container mx-auto max-w-screen-xl text-black'>
        <div className='text-center flex flex-col items-center'>
          <div className='md-flex'>
            ...
            <div>
              <p className='flex justify-center text-[8px] md:text-[15px] lg:text-[18px] place-content-center tracking-tight mt-2 lg:mt-5'>Need to know the right path for you? We're on it. Pathfinder recommend three courses<br /> for you base on your knowledge, 
                so there's always more to discover.</p>
            </div>
