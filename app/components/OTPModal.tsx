          ...
          <div className="bg-brown-1 p-6 md:p-12 lg:p-20 rounded-lg shadow-lg w-full max-w-md md:max-w-lg lg:max-w-2xl flex flex-col relative z-10">
            ...
            <form>
              <div className="mb-6 relative">
                <input type="text" placeholder="Enter OTP" className="w-full p-4 pr-12 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-black" />
                <FaKey className="absolute right-4 top-4 text-black" />
              </div>
              <button type="submit" className="w-full py-4 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition duration-300">Confirm</button>
            </form>
            <div className="mt-4 text-center">
              <button onClick={handleSendAnotherOTP} className="text-blue-500 hover:underline">Send another OTP</button>
            </div>
          </div>
        </div>
      )}
