      ...
      {isVisible && (
        <div className="flex justify-center items-center h-full mt-20">
          <div className="bg-brown-1 p-8 md:p-12 lg:p-16 rounded-lg shadow-lg w-full max-w-lg md:max-w-3xl lg:max-w-5xl xl:max-w-7xl flex relative z-10 transition-all duration-500">
            ...
            <div className="w-full md:w-full lg:w-1/2 p-8 md:p-10 lg:p-12 bg-brown-1 md:bg-brown-6 rounded-lg">
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-semibold mt-6 md:mt-8 lg:mt-10 mb-6 md:mb-8 lg:mb-10 text-center text-white">PathFinder</h2>
              <div className="mt-4 md:mt-6 lg:mt-8">
                <form onSubmit={(e) => { e.preventDefault(); handleLogin(); }} autoComplete="off">
                  <div className="mb-4 md:mb-4 lg:mb-8 mt-8 md:mt-10 lg:mt-12 relative">
                    <input type="text" placeholder="Enter your username" className="w-full p-4 md:p-5 lg:p-6 pr-10 md:pr-12 lg:pr-14 border rounded-lg focus:outline-none focus:ring-2 focus:ring-brown-700 bg-white text-black" value={username} onChange={(e) => setUsername(e.target.value)} autoComplete="off" />
                  ...
                  <div className="mb-4 md:mb-6 lg:mb-8 relative">
                    <input type={showPassword ? "text" : "password"} placeholder="Enter your password" className="w-full p-4 md:p-5 lg:p-6 pr-10 md:pr-12 lg:pr-14 border rounded-lg focus:outline-none focus:ring-2 focus:ring-brown-700 bg-white text-black" value={passwordValue} onChange={handlePasswordChange} autoComplete="off" />
                    {passwordValue && (
                  ...
                  <button type="submit" className="w-full py-4 md:py-5 lg:py-6 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition duration-300">Login</button>
                </form>
                <div className="mt-4 md:mt-4 lg:mt-8 text-center">
                  <p className="text-lg md:text-xl lg:text-2xl text-black">
                    Don't have an account? <button onClick={onSwitchToRegister} className="text-blue-500 hover:underline">Sign up</button>
                  </p>
                </div>
              </div>
            </div>
            <div className="hidden lg:flex lg:w-1/2 p-8 md:p-10 lg:p-12 justify-center items-center bg-white">
